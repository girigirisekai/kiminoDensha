...
public class twitterSearchAccidentJson {
		
	public String getAccident() throws Exception {

		String link = "https://api.twitter.com/1.1/search/tweets.json";

		// 한국어 UTF 엔코딩으로 변경하기 위한 団 (%20 단어 형태)
		
		String addrResult = link;
		// 링크 생성
