...
public class stationDB {
	...
	public stationDB(String station_nm, String station_nm2, String xpoint_wgs, String ypoint_wgs, String line_num,
	...
	public String toString() {
		return "stationDB [station_nm=" + station_nm + ", station_nm2=" + station_nm2 + ", xpoint_wgs=" + xpoint_wgs
				+ ", ypoint_wgs=" + ypoint_wgs + ", line_num=" + line_num + ", cyber_st_code=" + cyber_st_code + "]";
	}
